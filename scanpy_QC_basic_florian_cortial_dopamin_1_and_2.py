...
import os
os.chdir("/content/drive/Shared drives/CARD/projects/iNDI/line_prioritization/projects_lirong/Florian_data/data/filtered_cellranger_matrix/cortical_dopaminergic_sample_2")
...
sample_name = 'cortical_dopaminergic_sample_2'
